...
# kerala bus
lists_k=[]
df_k=pd.read_csv("C:\\Users\\thiya\\OneDrive\\Desktop\\Data Science - Guvi\\Project data - Redbus\\df_k.csv")
for i,r in df_k.iterrows():
    lists_k.append(r["Route_name"])

#Andhra bus
lists_A=[]
df_A=pd.read_csv("C:\\Users\\thiya\\OneDrive\\Desktop\\Data Science - Guvi\\Project data - Redbus\\df_A.csv")
for i,r in df_A.iterrows():
    lists_A.append(r["Route_name"])

#Telungana bus
lists_T=[]
df_T=pd.read_csv("C:\\Users\\thiya\\OneDrive\\Desktop\\Data Science - Guvi\\Project data - Redbus\\df_T.csv")
for i,r in df_T.iterrows():
    lists_T.append(r["Route_name"])

#Goa bus
lists_g=[]
df_G=pd.read_csv("C:\\Users\\thiya\\OneDrive\\Desktop\\Data Science - Guvi\\Project data - Redbus\\df_G.csv")
for i,r in df_G.iterrows():
    lists_g.append(r["Route_name"])

#Rajastan bus
lists_R=[]
df_R=pd.read_csv("C:\\Users\\thiya\\OneDrive\\Desktop\\Data Science - Guvi\\Project data - Redbus\\df_R.csv")
...
# South bengal bus 
lists_SB=[]
df_SB=pd.read_csv("C:\\Users\\thiya\\OneDrive\\Desktop\\Data Science - Guvi\\Project data - Redbus\\df_SB.csv")
for i,r in df_SB.iterrows():
    lists_SB.append(r["Route_name"])

# Haryana bus
lists_H=[]
df_H=pd.read_csv("C:\\Users\\thiya\\OneDrive\\Desktop\\Data Science - Guvi\\Project data - Redbus\\df_H.csv")
for i,r in df_H.iterrows():
    lists_H.append(r["Route_name"])

#Assam bus
lists_AS=[]
df_AS=pd.read_csv("C:\\Users\\thiya\\OneDrive\\Desktop\\Data Science - Guvi\\Project data - Redbus\\df_AS.csv")
for i,r in df_AS.iterrows():
    lists_AS.append(r["Route_name"])

#UP bus
lists_UP=[]
df_UP=pd.read_csv("C:\\Users\\thiya\\OneDrive\\Desktop\\Data Science - Guvi\\Project data - Redbus\\df_UP.csv")
for i,r in df_UP.iterrows():
    lists_UP.append(r["Route_name"])

#West bengal bus
lists_WB=[]
df_WB=pd.read_csv("C:\\Users\\thiya\\OneDrive\\Desktop\\Data Science - Guvi\\Project data - Redbus\\df_WB.csv")
for i,r in df_WB.iterrows():
    lists_WB.append(r["Route_name"])

#North bengal bus
lists_NB=[]
df_NB=pd.read_csv("C:\\Users\\thiya\\OneDrive\\Desktop\\Data Science - Guvi\\Project data - Redbus\\df_NB.csv")
for i,r in df_NB.iterrows():
    lists_NB.append(r["Route_name"])

#Karnataka bus
lists_KAR=[]
df_KAR=pd.read_csv("C:\\Users\\thiya\\OneDrive\\Desktop\\Data Science - Guvi\\Project data - Redbus\\df_KAR.csv")
for i,r in df_KAR.iterrows():
    lists_KAR.append(r["Route_name"])

#Karnataka bus
lists_CHAN=[]
df_CHAN=pd.read_csv("C:\\Users\\thiya\\OneDrive\\Desktop\\Data Science - Guvi\\Project data - Redbus\\df_CHAN.csv")
for i,r in df_CHAN.iterrows():
    lists_CHAN.append(r["Route_name"])
...
if web=="Home":
    ...
    slt.subheader(":red[Technical_Tags:]")
    slt.markdown("Selenium, Python, Pandas, MySQL,mysql-connector-python, Streamlit.")
    slt.subheader(":red[Developed-by:]  THIYAGARAJAN")

# States and Routes page setting
if web == "📍States and Routes":
    S = slt.selectbox("Lists of States", ["Kerala", "Adhra Pradesh", "Telugana", "Goa", "Rajastan", 
                                          "South Bengal", "Haryana", "Assam", "Uttar Pradesh", "West Bengal", "North Bengal", "Karnataka", "Chandigarh"])
...
# Kerala bus fare filtering
    if S == "Kerala":
        ...
        def type_and_fare(bus_type, fare_range):
            conn = mysql.connector.connect(host="127.0.0.1", user="root", password="ASdf", database="REDBUS")
...
# North Bengal bus fare filtering
    if S=="North Bengal":
        NB=slt.selectbox("list of rotes",lists_NB)

        def type_and_fare_NB(bus_type, fare_range):
            conn = mysql.connector.connect(host="127.0.0.1", user="root", password="ASdf", database="REDBUS")
            my_cursor = conn.cursor()
            # Define fare range based on selection
            if fare_range == "50-1000":
        ...
        df_result = type_and_fare_NB(select_type, select_fare)
        slt.dataframe(df_result)
# Karnataka bus fare filtering
    if S=="karnataka":
        KAR=slt.selectbox("list of rotes",lists_KAR)

        def type_and_fare_KAR(bus_type, fare_range):
            conn = mysql.connector.connect(host="127.0.0.1", user="root", password="ASdf", database="REDBUS")
            my_cursor = conn.cursor()
            # Define fare range based on selection
            if fare_range == "50-1000":
        ...
        df_result = type_and_fare_KAR(select_type, select_fare)
        slt.dataframe(df_result)
# Chandigarh bus fare filtering
    if S=="Chandigarh":
        CHAN=slt.selectbox("list of rotes",lists_CHAN)

        def type_and_fare_CHAN(bus_type, fare_range):
            conn = mysql.connector.connect(host="127.0.0.1", user="root", password="ASdf", database="REDBUS")
            my_cursor = conn.cursor()
            # Define fare range based on selection
            if fare_range == "50-1000":
        ...
        df_result = type_and_fare_CHAN(select_type, select_fare)
        slt.dataframe(df_result)
